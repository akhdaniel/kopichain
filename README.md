...
**Smart contract** dibuat dengan bahasa solidity dan bantuan framework hardhat. Masuk ke forlder **hardhat** untuk mendevelop, testing, dan delpoy smart contract ke jaringan blockchain BSC, ETH, Arbitrum, dan EVM based lainnya.
